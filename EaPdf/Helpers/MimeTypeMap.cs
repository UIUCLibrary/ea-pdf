namespace UIUCLibrary.EaPdf.Helpers
{
    ...
    public static class MimeTypeMap
    {
        ...
        public static readonly Dictionary<string, string> MimeTypeCorrections = new(StringComparer.OrdinalIgnoreCase) 
        { 
            { "file/pdf","application/pdf"}, 
            { "webmail/doc", "application/msword"} 
        };
        ...
        private static IDictionary<string, string> BuildMappings()
        {
            var mappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) {
                ...
                {DefaultExtension, "application/octet-stream"},
                {".bmp", "image/bmp"},
                {".c", "text/plain"},
        ...
        /// </summary>
        /// <param name="filePath">The filename or extension with the leading period.</param>
        ...
        public static string GetMimeType(string filePath)
        {
            ...
            if( _mappings.Value.TryGetValue(ext, out string? mimeType))
            {
                return mimeType;
            }
            else
        ...
        public static string GetExtension(string mimeType)
        {
            ...
            {
                throw new ArgumentException($"Requested mime type '{mimeType}' is not valid; missing '/'.", nameof(mimeType));
            }
