...
namespace UIUCLibrary.TestEaPdf
{
    ...
    public class TestEmailToXmlFunctions
    {
        ...
        //Gmail Exports
        [DataRow("Gmail\\Eml\\Inbox", "Inbox.out", "SHA256", false, false, false, false, false, 0, 87, 330, DisplayName = "xhtml-gmail-emls")] //gmail mbox export file
        ...
        [DataRow("Gmail\\account.mbox", "", "SHA256", false, false, false, false, false, 0, 87, 331, DisplayName = "xhtml-gmail-mbox")] //gmail mbox export file

        //Mozilla mbox with child mboxes, different combinations of settings
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha1", "SHA1", false, false, false, false, false, 0, 9, 384, DisplayName = "xhtml-moz-dlf-sha1")]
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256", "SHA256", false, false, false, false, false, 0, 9, 384, DisplayName = "xhtml-moz-dlf-sha256")]
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256-ext", "SHA256", true, false, false, false, false, 0, 9, 475, DisplayName = "xhtml-moz-dlf-sha256-ext")]
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256-ext---includeSubs", "SHA256", true, false, false, true, false, 0, 38, 848, DisplayName = "xhtml-moz-dlf-sha256-ext---includeSubs")]
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256-ext-wrap", "SHA256", true, true, false, false, false, 0, 9, 475, DisplayName = "xhtml-moz-dlf-sha256-ext-wrap")]
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256-ext-wrap-presvEnc", "SHA256", true, true, true, false, false, 0, 9, 475, DisplayName = "xhtml-moz-dlf-sha256-ext-wrap-presvEnc")]
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256----includeSubs", "SHA256", false, false, false, true, false, 0, 38, 701, DisplayName = "xhtml-moz-dlf-sha256----includeSubs")]
        //Test maximum output file size
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256----includeSubs-10000000", "SHA256", false, false, false, true, false, 0, 38, 701, false, 10000000, DisplayName = "xhtml-moz-dlf-sha256----includeSubs-10000000")]
        [DataRow("MozillaThunderbird\\DLF Distributed Library", "dlf-sha256---presvEnc", "SHA256", false, false, true, false, false, 0, 9, 384, DisplayName = "xhtml-moz-dlf-sha256---presvEnc")]
        //Mozilla special files
        [DataRow("MozillaThunderbird\\Drafts", "", "SHA256", false, false, false, false, false, 0, 0, 26, DisplayName = "xhtml-moz-drafts")]
        [DataRow("MozillaThunderbird\\Inbox", "", "SHA256", false, false, false, false, false, 0, 15, 21, DisplayName = "xhtml-moz-inbox")]


        //Pine mbox folder
        [DataRow("Pine", "", "SHA256", false, false, false, false, false, 2, 627, 20795, DisplayName = "xhtml-pine-folder-one-file")]
        [DataRow("Pine", "pine-out-one", "SHA256", false, false, false, false, false, 2, 627, 20795, DisplayName = "xhtml-pine-folder-one-file-in-subfolder")]
        [DataRow("Pine", "pine-out-many", "SHA256", false, false, false, false, true, 2, 572, 20795, DisplayName = "xhtml-pine-folder-one-file-per-in-subfolder")]
        //Pine mbox files with special properties
        [DataRow("Pine\\sent-mail-aug-2007", "pine-sent-mail-aug-2007", "SHA256", false, false, false, false, false, 2, 277, 1300, DisplayName = "xhtml-pine-sent-mail-aug-2007")] //not an mbox file
        ...
        //Weird Emails
        [DataRow("Weird\\missing_ext2.mbox", "out_missing_ext2", "SHA256", true, false, false, false, false, 0, 0, 2, DisplayName = "xhtml-weird-missing-ext2-mbox")] //message from very large mbox seems to be missing external files
        ...
        [DataRow("Weird\\virus_payload.mbox", "out_virus_payload", "SHA256", true, false, false, false, false, 0, 2, 2, DisplayName = "xhtml-weird-virus-payload-mbox")] //message from very large mbox which contains a virus payload
        ...
        {
            TestSampleFiles(relInPath, relOutPath, hashAlg, extContent, wrapExtInXml, preserveEnc, includeSub, oneFilePerMbox, expectedErrors, expectedWarnings, expectedCounts, quick, maxOutFileSize, true);
        }
